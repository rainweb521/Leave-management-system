    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 假条模板打印
            </div>
        ...
        <div class="tpl-block">
            ...
            <ul class="tpl-task-list tpl-task-remind">
                <li>
                    <div class="cosB"></div>
                    <div class="cosA"><span class="cosIco"><i class="am-icon-file-o"></i></span>
                        <span> 短期假条模板<a target="_blank" href="/index.php?c=leave&a=printf&tip=2"><span class="tpl-label-info"> 前去打印<i class="am-icon-share"></i></span></a></span>
                    </div>
                ...
                <li>
                    <div class="cosB"></div>
                    <div class="cosA"><span class="cosIco"><i class="am-icon-file-o"></i></span>
                        <span> 长期假条模板<a target="_blank" href="/index.php?c=leave&a=printf&tip=1"><span class="tpl-label-info"> 前去打印<i class="am-icon-share"></i></span></a></span>
                    </div>
                </li>
