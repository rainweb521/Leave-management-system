            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 假条审核
                    </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <?php if(is_array($leave_list)): $i = 0; $__LIST__ = $leave_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="am-hide-sm-only">
                                                <a class="label label-sm " style="background-color: #ed6b75" id="state<?php echo ($list["l_id"]); ?>" onclick="set_State('<?php echo ($list["l_id"]); ?>')">未审核</a><span id="statt<?php echo ($list["l_id"]); ?>">&nbsp;点击通过</span>
...
<script>
    ...
    function set_State(obj){
        ...
        $.get("/index.php?c=leave&a=set_state&tip=1&l_id=" + obj);
        document.getElementById('state'+obj).style.backgroundColor = "#1E9FFF";
        document.getElementById('state'+obj).innerHTML = "s审核通过";
