                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" id="my_form" method="post" action="/index.php?c=grade&a=apply">
                                ...
                                <!--<div class="am-form-group">-->
                                    ...
                                    <!--<div class="am-u-sm-9">-->
                                        <!--<input type="tel" name="l_s_phone" id="user-phone" placeholder="输入手机号">-->
                                    <!--</div>-->
                                <!--</div>-->
                                <!--<div class="am-form-group">-->
...
<script>
    function validate() {
        ...
        if (g_name == ''){
            document.getElementById('state').innerHTML = '级别名称未填写';
        }else {
