                            ...
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <?php if(is_array($grade_list)): $i = 0; $__LIST__ = $grade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="am-hide-sm-only"><?php echo ($list["g_addtime"]); ?></td>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        ...
                                                        <a href="/index.php?c=grade&a=delete&g_id=<?php echo ($list["g_id"]); ?>" style="color: red;" ><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
